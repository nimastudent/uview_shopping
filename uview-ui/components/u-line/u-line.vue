...
<script>
	 ...
	 * @property {String} length 长度，竖向时表现为高度，横向时表现为长度，可以为百分比，带upx单位的值等
	 ...
	 * @property {String} margin 线条与上下左右元素的间距，字符串形式，如"30upx"
	...
	export default {
		...
		props: {
			...
			// 长度，竖向时表现为高度，横向时表现为长度，可以为百分比，带upx单位的值等
			length: {
				type: String,
				default: '100%'
			},
			...
			// 线条与上下左右元素的间距，字符串形式，如"30upx"、"20upx 30upx"
			margin: {
				type: String,
				default: '0'
			},
