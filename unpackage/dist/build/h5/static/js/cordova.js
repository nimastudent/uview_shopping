...
if (/android (\d+\.\d+)/.test(userAgent)) {
  (function () {
    ...
    define("cordova/exec", function (require, exports, module) {
      ...
      function androidExec(success, fail, service, action, args) {
        ...
        if (jsToNativeBridgeMode == jsToNativeModes.LOCATION_CHANGE) {
          ...
          var messages = nativeApiProvider
            .get()
            .exec(service, action, callbackId, argsJson);
      ...
      module.exports = {
        ...
        initialize: function () {
          ...
          backButtonChannel.onHasSubscribersChange = function () {
            exec(null, null, "App", "overrideBackbutton", [
              this.numHandlers == 1,
            ]);
          };
    ...
    define("cordova/plugin/Camera", function (require, exports, module) {
      ...
      cameraExport.getPicture = function (
        ...
        var destinationType = getValue(
          options.destinationType,
          Camera.DestinationType.FILE_URI
        );
        var sourceType = getValue(
          options.sourceType,
          Camera.PictureSourceType.CAMERA
        );
        var targetWidth = getValue(options.targetWidth, -1);
        var targetHeight = getValue(options.targetHeight, -1);
        var encodingType = getValue(
    ...
    define(
      "cordova/plugin/CameraPopoverHandle",
      function (require, exports, module) {
        var exec = require("cordova/exec");
        var CameraPopoverHandle = function () {
          this.setPosition = function (popoverOptions) {
            console.log(
              "CameraPopoverHandle.setPosition is only supported on iOS."
            );
          };
        };
    ...
    define(
      "cordova/plugin/CameraPopoverOptions",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/CaptureAudioOptions",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/CaptureImageOptions",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/CaptureVideoOptions",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/ConfigurationData",
      function (require, exports, module) {
    ...
    define("cordova/plugin/Contact", function (require, exports, module) {
      ...
      function convertIn(contact) {
        ...
        try {
          ...
          console.log(
            "Cordova Contact convertIn error: exception creating date."
          );
        }
        return contact;
      }
      ...
      Contact.prototype.save = function (successCB, errorCB) {
        ...
        var success = function (result) {
          if (result) {
            if (successCB) {
              var fullContact = require("cordova/plugin/contacts").create(
                result
              );
    ...
    define(
      "cordova/plugin/ContactFindOptions",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/ContactOrganization",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/DirectoryReader",
      function (require, exports, module) {
        var exec = require("cordova/exec"),
          FileError = require("cordova/plugin/FileError");
            ...
            if (entry) {
              if (successCallback) {
                var result = entry.isDirectory
                  ? new (require("cordova/plugin/DirectoryEntry"))(
                      entry.name,
                      entry.fullPath
                    )
                  : new (require("cordova/plugin/FileEntry"))(
                      entry.name,
                      entry.fullPath
                    );
    ...
    define("cordova/plugin/FileReader", function (require, exports, module) {
      ...
      function initRead(reader, file) {
        ...
        if (typeof file == "string") {
          console.warning(
            "Using a string argument with FileReader.readAs functions is deprecated."
          );
    ...
    define("cordova/plugin/FileTransfer", function (require, exports, module) {
      ...
      function getBasicAuthHeader(urlString) {
        ...
        if (window.btoa) {
          ...
          if (credentials) {
            ...
            header = { name: authHeader, value: authHeaderValue };
          }
        }
        return header;
      }
      ...
      FileTransfer.prototype.download = function (
        ...
        exec(win, fail, "FileTransfer", "download", [
          source,
          target,
          trustAllHosts,
          this._id,
      ...
      FileTransfer.prototype.abort = function (successCallback, errorCallback) {
        exec(successCallback, errorCallback, "FileTransfer", "abort", [
          this._id,
        ]);
      };
    ...
    define(
      "cordova/plugin/FileTransferError",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/FileUploadOptions",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/FileUploadResult",
      function (require, exports, module) {
    ...
    define("cordova/plugin/FileWriter", function (require, exports, module) {
      ...
      FileWriter.prototype.write = function (text) {
        ...
        exec(
          ...
          "File",
          "write",
          [this.fileName, text, this.position]
        );
      };
    ...
    define(
      "cordova/plugin/GlobalizationError",
      function (require, exports, module) {
    ...
    define(
      "cordova/plugin/LocalFileSystem",
      function (require, exports, module) {
        var exec = require("cordova/exec");
    ...
    define("cordova/plugin/MediaFile", function (require, exports, module) {
      ...
      MediaFile.prototype.getFormatData = function (
        successCallback,
        errorCallback
      ) {
        if (typeof this.fullPath === "undefined" || this.fullPath === null) {
          errorCallback(
            new CaptureError(CaptureError.CAPTURE_INVALID_ARGUMENT)
          );
        } else {
    ...
    define("cordova/plugin/Metadata", function (require, exports, module) {
      var Metadata = function (time) {
        this.modificationTime =
          typeof time != "undefined" ? new Date(time) : null;
      };
      ...
      function (require, exports, module) {
        ...
        module.exports = {
          overrideBackButton: function () {
            console.log(
              "Device.overrideBackButton() is deprecated.  Use App.overrideBackbutton(true)."
            );
            app.overrideBackbutton(true);
          },
          resetBackButton: function () {
            console.log(
              "Device.resetBackButton() is deprecated.  Use App.overrideBackbutton(false)."
            );
    ...
    define(
      "cordova/plugin/android/nativeapiprovider",
      function (require, exports, module) {
        var nativeApi =
          this._cordovaNative ||
    ...
    define(
      "cordova/plugin/android/notification",
      function (require, exports, module) {
        var exec = require("cordova/exec");
        module.exports = {
    ...
    define(
      "cordova/plugin/android/promptbasednativeapi",
      function (require, exports, module) {
        module.exports = {
    ...
    define(
      ...
      function (require, exports, module) {
            ...
            try {
              ...
              if (tx && tx.queryList[id]) {
                ...
                try {
                  ...
                  console.log(
                    "executeSql error calling user success callback: " + ex
                  );
                }
                tx.queryComplete(id);
              }
            ...
            try {
              ...
              if (tx && tx.queryList[id]) {
                ...
                try {
                  ...
                  console.log(
                    "executeSql error calling user error callback: " + ex
                  );
                }
          ...
          if (this.successCallback) {
            ...
            if (count === 0) {
              try {
                ...
                console.log(
                  "Transaction error calling user success callback: " + e
                );
              }
            }
          }
        ...
        DroidDB_Tx.prototype.queryFailed = function (id, reason) {
          ...
          if (this.errorCallback) {
            try {
              ...
              console.log(
                "Transaction error calling user error callback: " + e
              );
            }
          }
        };
        ...
        var DroidDB_openDatabase = function (
          name,
          version,
          display_name,
          size
    ...
    define(
      "cordova/plugin/android/storage/openDatabase",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper"),
          storage = require("cordova/plugin/android/storage");
        var originalOpenDatabase = modulemapper.getOriginalSymbol(
          window,
          "openDatabase"
        );
    ...
    define(
      "cordova/plugin/android/storage/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
    ...
    define(
      "cordova/plugin/battery/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
    ...
    define(
      "cordova/plugin/capture/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
      ...
      var argscheck = require("cordova/argscheck"),
        ...
        compass = {
          getCurrentHeading: function (
            ...
            var win = function (result) {
              var ch = new CompassHeading(
                result.magneticHeading,
                result.trueHeading,
                result.headingAccuracy,
                result.timestamp
              );
              successCallback(ch);
            };
          ...
          watchHeading: function (successCallback, errorCallback, options) {
            ...
            var frequency =
              options !== undefined && options.frequency !== undefined
                ? options.frequency
                : 100;
            var filter =
              options !== undefined && options.filter !== undefined
                ? options.filter
                : 0;
            var id = utils.createUUID();
            if (filter > 0) {
    ...
    define(
      "cordova/plugin/compass/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.clobbers(
          "cordova/plugin/CompassHeading",
    ...
    define(
      "cordova/plugin/console-via-logger",
      function (require, exports, module) {
      ...
      var contacts = {
        ...
        create: function (properties) {
          ...
          for (var i in properties) {
            if (
              typeof contact[i] !== "undefined" &&
              properties.hasOwnProperty(i)
            ) {
    ...
    define(
      "cordova/plugin/contacts/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/echo", function (require, exports, module) {
      ...
      module.exports = function (
        ...
        if (utils.typeName(message) == "ArrayBuffer") {
          if (forceAsync) {
            console.warn(
              "Cannot echo ArrayBuffer with forced async, falling back to sync."
            );
          }
          action += "ArrayBuffer";
        } else {
          if (messageIsMultipart) {
            if (forceAsync) {
              console.warn(
                "Cannot echo MultiPart Array with forced async, falling back to sync."
              );
            }
            action += "MultiPart";
          } else {
    ...
    define(
      "cordova/plugin/file/symbolshelper",
      function (require, exports, module) {
        module.exports = function (exportFunc) {
          ...
          exportFunc(
            "cordova/plugin/resolveLocalFileSystemURI",
    ...
    define(
      "cordova/plugin/filetransfer/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
    ...
    define(
      "cordova/plugin/geolocation/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.defaults(
    ...
    define(
      "cordova/plugin/globalization/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.clobbers(
    ...
    define(
      "cordova/plugin/inappbrowser/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
      ...
      logger.useConsole = function (value) {
        ...
        if (UseConsole) {
          ...
          if (typeof console.log != "function") {
            throw new Error(
              "global console object does not have a log function"
            );
          }
    ...
    define(
      "cordova/plugin/networkstatus/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.clobbers(
          "cordova/plugin/network",
          "navigator.network.connection",
          "navigator.network.connection is deprecated. Use navigator.connection instead."
        );
    ...
    define("cordova/plugin/notification", function (require, exports, module) {
      ...
      module.exports = {
        ...
        prompt: function (message, resultCallback, title, buttonLabels) {
          ...
          var _buttonLabels = buttonLabels || ["OK", "Cancel"];
          exec(resultCallback, null, "Notification", "prompt", [
            _message,
            _title,
            _buttonLabels,
          ]);
    ...
    define(
      "cordova/plugin/notification/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.clobbers(
    ...
    define(
      "cordova/plugin/requestFileSystem",
      function (require, exports, module) {
        var argscheck = require("cordova/argscheck"),
          FileError = require("cordova/plugin/FileError"),
    ...
    define(
      "cordova/plugin/splashscreen/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.clobbers(
    ...
    (function (context) {
      ...
      function handlePluginsObject(modules) {
        ...
        onScriptLoadingComplete = function () {
          for (var i = 0; i < modules.length; i++) {
            ...
            if (
              module.runs &&
              !(module.clobbers && module.clobbers.length) &&
              !(module.merges && module.merges.length)
            ) {
      ...
      try {
        ...
        xhr.open("GET", "cordova_plugins.json", true);
        xhr.send();
      } catch (err) {
        finishPluginLoading();
      }
  ...
  (function () {
    ...
    define("cordova/exec", function (require, exports, module) {
      ...
      function iOSExec() {
        if (bridgeMode === undefined) {
          bridgeMode =
            navigator.userAgent.indexOf(" 4_") == -1
      ...
      module.exports = {
        display: function (errorCB, options) {
          if (this.id === null) {
            ...
            exec(null, errorCB, "Contacts", "displayContact", [
              this.id,
              options,
            ]);
          }
    ...
    define(
      "cordova/plugin/ios/console/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
    ...
    define(
      "cordova/plugin/ios/contacts/symbols",
      function (require, exports, module) {
        require("cordova/plugin/contacts/symbols");
        var modulemapper = require("cordova/modulemapper");
        modulemapper.merges(
          "cordova/plugin/ios/contacts",
          "navigator.contacts"
        );
    ...
    define(
      "cordova/plugin/ios/geolocation/symbols",
      function (require, exports, module) {
        var modulemapper = require("cordova/modulemapper");
        modulemapper.merges(
          "cordova/plugin/geolocation",
    ...
    define(
      "cordova/plugin/ios/logger/plugininit",
      function (require, exports, module) {
        var logger = require("cordova/plugin/logger");
